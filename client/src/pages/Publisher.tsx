          ...
          <div className="space-y-6">
            ...
            <div className="border-4 border-zinc-700 bg-zinc-900 p-6">
              ...
              <div className="mt-6 flex items-center justify-center">
                <div
                  className={`flex items-center justify-center border-4 border-dashed border-zinc-600 bg-zinc-800 font-mono text-xs uppercase text-zinc-500 ${
                    selectedType === "banner" ? "h-[90px] w-full max-w-[728px]" : ""
                  } ${selectedType === "square" ? "h-[200px] w-[200px]" : ""} ${
                    selectedType === "sidebar" ? "h-[300px] w-[150px]" : ""
                  }`}
                >
